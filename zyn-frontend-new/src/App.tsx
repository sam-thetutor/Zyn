          ...
          <Router>
            <Layout>
              <Routes>
                ...
                <Route path="/create-market" element={<div className="p-8 text-center"><h1 className="text-2xl font-bold text-gray-900">Create Market</h1><p className="text-gray-600 mt-2">Coming soon...</p></div>} />
