...
import type { Market, PotentialWinnings } from '../types/contracts';
    ...
    <div className={`bg-white rounded-lg shadow-sm border border-gray-200 p-6 ${className}`}>
      ...
      {loading ? (
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-green-600">
                  +{formatWinnings(potentialWinnings.potentialWinnings - potentialWinnings.investmentAmount)} CELO
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm">
                <div className="font-medium text-yellow-800 mb-1">Risk Warning</div>
                <p className="text-yellow-700">
                  If you're wrong, you lose your entire investment. Only invest what you can afford to lose.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-600">Enter an investment amount to see potential winnings</p>
        </div>
      )}
    </div>
  );
