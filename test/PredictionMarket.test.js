...
describe("PredictionMarket", function () {
  ...
  describe("Deployment", function () {
    ...
    it("Should set correct initial fees", async function () {
      expect(await predictionMarket.marketCreationFee()).to.equal(ethers.utils.parseEther("0.001"));
      expect(await predictionMarket.tradingFee()).to.equal(ethers.utils.parseEther("0.005"));
    });
  ...
  describe("Fee Management", function () {
    ...
    it("Should allow owner to update trading fee", async function () {
      const newFee = ethers.utils.parseEther("0.01"); // 1%
    ...
    it("Should fail to set trading fee above 5%", async function () {
      const highFee = ethers.utils.parseEther("0.06"); // 6%
